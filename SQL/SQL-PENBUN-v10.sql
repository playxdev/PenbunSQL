/* =====================================================================================
   SQL-PENBUN-v10.sql   —   STANDALONE FULL BUILD
   -------------------------------------------------------------------------------------
   Generated : 2026-08-26
   Scope     : DROP & CREATE ทั้งฐานข้อมูล  34 ตาราง  ไม่มี ALTER แม้แต่บรรทัดเดียว
   Replaces  : SQL-PENBUN-v9.sql  (ห้ามรันร่วมกัน)
...
/* =====================================================================================
   ...
   -------------------------------------------------------------------------------------
   ตัวเลขที่ต้องได้ใน v10 — เท่า v9 ทุกบรรทัด v10 เพิ่มแต่คอลัมน์
   (วัดจากการติดตั้งจริงบน SQL Server) :
     tables 34 · views 32 · procedures 11 · functions 1
