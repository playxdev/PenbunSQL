/* =====================================================================================
   SQL-PENBUN-v11.sql   —   STANDALONE FULL BUILD
   -------------------------------------------------------------------------------------
   Generated : 2026-08-27
   Scope     : DROP & CREATE ทั้งฐานข้อมูล  34 ตาราง  ไม่มี ALTER แม้แต่บรรทัดเดียว
   Replaces  : SQL-PENBUN-v10.sql  (ห้ามรันร่วมกัน)
...
/* =====================================================================================
   ...
   -------------------------------------------------------------------------------------
   ตัวเลขที่ต้องได้ใน v11 — เท่า v10 ทุกบรรทัด ยกเว้น views ที่ vw_users เพิ่มให้หนึ่ง
   (วัดจากการติดตั้งจริงบน SQL Server) :
     tables 34 · views 33 · procedures 11 · functions 1
     triggers 136 · foreign_keys 55 · check_const 19 · indexes 122
